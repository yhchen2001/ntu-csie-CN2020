...
func ChatWithAnon(conn net.Conn) {
	...
	// starts chatting
	withAnonDisplayHistory(conn)

	withAnonStartChat(conn)
}

func withAnonStartChat(conn net.Conn){
...
func withAnonDisplayHistory(conn net.Conn) {
